...
from hand_keypoint.common.nets.layer import MLP
from hand_keypoint.common.nets.module import BackboneNet, DecoderNet, DecoderNet_big
from hand_keypoint.common.nets.transformer import Transformer
from hand_keypoint.common.nets.loss import *
from hand_keypoint.common.nets.position_encoding import build_position_encoding
from hand_keypoint.common.utils.preprocessing import PeakDetector
from hand_keypoint.common.utils.misc import *
import numpy as np
import time
...
class Model(nn.Module):
    ...
    def get_input_seq(self, joint_heatmap_out, obj_seg_out, feature_pyramid, pos_embed, epoch_cnt):
    ...
    def forward(self, inputs, mode, epoch_cnt=1e8):
        ...
        input_seq, masks, positions, joint_loc_pred_np, mask_np, peak_joints_map_batch \
            = self.get_input_seq(joint_heatmap_out, obj_seg_out, feature_pyramid, pos,epoch_cnt)
