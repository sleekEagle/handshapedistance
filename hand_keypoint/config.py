...
import sys
from hand_keypoint.common.utils.dir import add_pypath, make_folder
...
class Config:
    ...
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
      ...
      #~~~~~~~~~~~~~~~~~~~~~~SMPLX path~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    smplx_path = "D:\\data\\mano_v1_2\\mano_v1_2\\models\\" # Path to MANO model files
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#


    # ~~~~~~~~~~~~~~~~~~~~~~InterHand2.6M paths~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    interhand_anno_dir = 'D:\\data\\InterHand2.6M_5fps_batch1\\annotations\\'
    interhand_images_path = 'D:\\data\\InterHand2.6M_5fps_batch1\\images\\'

    # RootNet output path
    root_net_output_path = None
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    ...
    joint_regr_np_path=os.path.join(os.path.curdir, os.path.join('hand_keypoint','tool', 'MANO_joint_regressor', 'J_regressor_mano_ih26m.npy'))
    assert os.path.exists(joint_regr_np_path), 'Unable to find J_regressor_mano_ih26m.npy'

    skeleton_file=os.path.join(os.path.curdir, os.path.join('hand_keypoint','tool', 'hand_skeleton', 'skeleton.txt'))
    assert os.path.exists(skeleton_file), 'Unable to find skeleton.txt'

    obj_kps_dir=os.path.join(os.path.curdir, os.path.join('tool', 'ho3d_object_kps'))
